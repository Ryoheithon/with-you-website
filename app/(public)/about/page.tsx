  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        {/* 代表挨拶セクション */}
        <div className="bg-white rounded-xl shadow-md p-8 border border-gray-100 mb-16 animate-fade-in">
          <div className="flex flex-col md:flex-row gap-8 items-center mb-8">
            ...
            <div className="md:w-2/3">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 bg-gradient-to-r from-[#ED765E] to-[#FEA858] bg-clip-text text-transparent">
                子どもたちの未来を支える教育を
              </h2>
        ...
        {/* 推薦文セクション */}
        <div className="bg-white rounded-xl shadow-md p-8 border border-gray-100 mb-16 animate-fade-in animation-delay-300">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-[#ED765E]/10 to-[#FEA858]/10 rounded-lg p-6 border-l-4 border-[#ED765E]">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-10 text-white/90">
                まずは無料相談で、With-youの教育サポートについてご相談ください。
                お子様の状況や目標に合わせた提案をいたします。
              </p>
